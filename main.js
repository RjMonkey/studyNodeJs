...
//while(1){
    var analogTempValue = analogPin0.read(); //read the value of the analog pin
    var analogFireValue = analogPin1.read();
    var dataTemp = analogTempValue * (5 / 10.24);
    console.log('温度：'+ dataTemp); //write the value of the analog pin to the console

    console.log('火焰：'+ analogFireValue + '\n'); //write the value of the analog pin to the console
//}
